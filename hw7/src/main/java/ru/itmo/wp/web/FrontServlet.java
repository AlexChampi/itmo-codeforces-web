...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method method = findMethodByName(pageClass, route.getAction());
        ...
        Method before = findMethodByName(pageClass, "before");
        Method after = findMethodByName(pageClass, "after");
    ...
    private Method findMethodByName(Class<?> pageClass, String action) {
        Method method = null;
        for (Class<?> clazz = pageClass; method == null && clazz != null; clazz = clazz.getSuperclass()) {
            try {
